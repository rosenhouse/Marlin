...
MOTHERBOARD=81 ENABLE_AUTO_BED_LEVELING=1 AUTO_BED_LEVELING_ANY_POINTS=1 Z_SAFE_HOMING_FIXED_POINT=1 CUSTOM_M_CODES=1 CUSTOM_G_CODES=1 MSM_Printeer=1
run

MOTHERBOARD=81 ENABLE_AUTO_BED_LEVELING=1 AUTO_BED_LEVELING_ANY_POINTS=1 Z_SAFE_HOMING_FIXED_POINT=1 CUSTOM_M_CODES=1 CUSTOM_G_CODES=1e
run
