...
function run
{
    ...
    cp $CFG $CFG.orig
    cat $CFG.orig | ./set-defines.sh MOTHERBOARD ENABLE_AUTO_BED_LEVELING CUSTOM_M_CODES MSM_Printeer FSR_BED_LEVELING > $CFG
    echo "Current defines:"
    grep -e MOTHERBOARD -e ENABLE_AUTO_BED_LEVELING -e DELTA -e CUSTOM_M_CODES -e MSM_Printeer -e FSR_BED_LEVELING $CFG
    sleep 2
...
MOTHERBOARD=81 ENABLE_AUTO_BED_LEVELING=1 CUSTOM_M_CODES=1 CUSTOM_G_CODES=1 MSM_Printeer=1
run

MOTHERBOARD=81 ENABLE_AUTO_BED_LEVELING=1 CUSTOM_M_CODES=1 MSM_Printeer=1
run

MOTHERBOARD=81 ENABLE_AUTO_BED_LEVELING=1 CUSTOM_M_CODES=1
run
